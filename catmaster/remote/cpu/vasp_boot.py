...
def main() -> int:
    ...
    parser.add_argument("--sync_delay", type=int, default=10, help="Sleep seconds after sync")
    parser.add_argument("--auto_gamma", action="store_true", help="Use gamma VASP when KPOINTS is Gamma")
    parser.add_argument("--gamma_vasp", default="vasp_gam", help="Gamma-point VASP binary")
    parser.add_argument("--kpoints", default="KPOINTS", help="KPOINTS file path")
    parser.add_argument("--auto_ncore", action="store_true", help="Auto-set NCORE when absent")
    parser.add_argument("--cpu_per_node", type=int, default=None, help="CPU per node hint for NCORE")
