...
def _fallback_summary(
    *,
    ...
    run_status = _infer_status(events, run_error=run_error)
...
def _infer_status(events: List[Dict[str, Any]], *, run_error: Optional[str]) -> str:
    if run_error:
        return "error"
...
def _get_summary_llm() -> Any:
    ...
    with _SUMMARY_LOCK:
        ...
        try:
            ...
            _SUMMARY_LLM = bundle.summary_llm
        except Exception:
            _SUMMARY_LLM = None
        return _SUMMARY_LLM
