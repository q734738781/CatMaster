...
class RelaxPrepareInput(BaseModel):
    ...
    - PAW-PBE54 POTCARS, ENCUT=520 eV, PREC=Accurate, ISPIN=2, IBRION=2, LREAL=AUTO, LASPH=True, LORBIT=11, LWAVE=False, LCHARG=False).
    - Additional overrides applied for relaxation robustness based on calc_type for different systems:
    - EDIFF=1e-6; NSW=500; EDIFFG=-0.02; ISMEAR=0, SIGMA=0.1 for solids; ISMEAR=0, SIGMA=0.01 for gas;
