...
def _build_generation_prompt(user_prompt: str) -> str:
    ...
    return "\n".join(
        [
            ...
            "Do not add decorative clutter, faux screenshots, unnecessary background textures, or dense paragraphs of text.",
            "If labels are needed, keep them short and figure-appropriate.",
            "Prefer a figure a chemistry/materials paper could plausibly include as a conceptual or mechanistic schematic.",
            "",
            "User figure request:",
            prompt,
        ]
