...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "ObservabilityStore": ("catmaster.runtime.observability_store", "ObservabilityStore"),
    ...
    "ObservabilityCallbackHandler": ("catmaster.runtime.artifact_callback", "ObservabilityCallbackHandler"),
