...
- **vasp_execute / vasp_execute_batch**: submit VASP jobs (single or batch) via DPDispatcher; uses `configs/dpdispatcher/*` and task defaults in `tasks.yaml` (or explicit tool inputs).
