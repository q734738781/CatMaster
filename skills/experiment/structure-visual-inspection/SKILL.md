...
- Prefer the ASE backend for experiment-side inspection because it preserves more explicit geometric context; reserve OVITO for manuscript-facing aesthetics.
