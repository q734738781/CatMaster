...
metadata:
  catmaster-suggested-tools: "enumerate_adsorption_sites place_adsorbate generate_batch_adsorption_structures vasp_prepare vasp_execute_batch analyze_vasp_results vaspkit_adsorbate_thermo_correction render_structure_views"
---
