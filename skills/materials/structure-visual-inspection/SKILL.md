...
## Workflow
1. Start with `python skills/materials/structure-visual-inspection/code/render_structure_panel.py STRUCTURE -o OUTPUT.png --show-cell` from the repo root or copy the script into the writable workspace if the runtime needs a local artifact.
