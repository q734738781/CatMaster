...
description: Audit and rewrite content to remove AI writing patterns ("AI-isms"). Use this skill when asked to reduce AI-like prose and whenever CatMaster finalizes a user-facing report, literature synthesis, review, summary document, memo, manuscript, or other prose-heavy artifact. Supports detect-only and edit-in-place modes, optional voice profiles, and iterate-to-convergence passes.
version: 3.14.0
license: MIT
...
metadata:
  ...
  catmaster-roles: "task_runner literature_deep_research write_director section_writer write_reviewer"
  catmaster-lanes: "experiment literature_review writing peer_review research"
  catmaster-tags: "writing prose quality"
