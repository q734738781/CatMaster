...
Choose one path from task availability and known input-style compatibility. Do not make CPU/GPU equivalence or execution on both paths a default preflight, scientific gate, or production prerequisite.
