...
- The validated baseline in this repo is `mace-mh-1` with `foundation_head=omat_pbe`, explicit replay controls, `compute_stress=True`, `energy_weight=1.0`, `forces_weight=100.0`, `stress_weight=1.0`, `default_dtype=float32`, and `seed=42`.
