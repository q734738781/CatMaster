...
- Record `extraction_confidence` for each block only from OCR, crop, reading-order, and text-extraction quality; mark low extraction confidence in `translation_notes.md` rather than guessing.
