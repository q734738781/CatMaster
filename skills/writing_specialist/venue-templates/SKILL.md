...
- Use `generate_nanobanana_figure` for conceptual, workflow, or mechanism-style visuals
- Simply describe your desired diagram in natural language
- Prefer this route over hand-built matplotlib diagrams when the figure is explanatory rather than quantitative

**For new documents:** Scientific schematics should be generated by default to visually represent key concepts, workflows, architectures, or relationships described in the text.

**How to generate schematics:**
- Call `generate_nanobanana_figure` with a concise natural-language prompt and a workspace-relative output path.
