...
This report evaluates [specific question] for [population, setting, and time
window]. Keep an additional scope condition only when it changes how the result
or recommendation should be interpreted.
...
[material condition]. The study design supports [exact evidence strength].
\end{limitations}
...
This research investigated [topic] using [methodology] with a sample of \samplesize{500} participants. The findings demonstrate that [main conclusion]. These results establish [evidence-supported implication] for [field/practice] and support [recommendation under its stated condition].
\end{executivesummary}
