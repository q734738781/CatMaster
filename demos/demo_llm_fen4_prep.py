...
def main() -> None:
    parser = argparse.ArgumentParser(description="LLM demo: Fe-N4-CO adsorption system geometry preparation")
    parser.add_argument("--workspace", default="workspace/demo_fen4_co", help="Workspace root")
    ...
    user_request = (
        "I need you to prepare the geometries for 1) a standard Fe-N4 single atom catalyst (Fe on graphene), and 2) CO adsorbed on the Fe site"
